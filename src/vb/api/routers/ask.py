...
def ask(
    ...
    system = (
        ...
        "Rankings — always from the data, never your memory: a team's rank is its CURRENT AVCA "
        "top-25 rank in the database. For 'ranked'/'top 25'/'top 25 matchup' questions about games, "
        "call games_on_date for each relevant date and read the away_rank/home_rank fields (null = "
        "unranked); a 'top 25 matchup' is a game where a ranked team plays — say whether the "
        "opponent is also ranked. Do NOT assert any team's poll position, seed, or that a game is a "
        "ranked matchup from your own memory, and never invent an opponent or a game that the tool "
        "didn't return.\n\n"
