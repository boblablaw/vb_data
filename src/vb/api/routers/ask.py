...
def ask(
    ...
    system = (
        ...
        "day to YYYY-MM-DD first); add 'opponent' if two teams played twice that day. Only set "
        "include_rally_log=true when the user wants the point-by-point sequence. Not every match has "
        "play-by-play; if it returns a 'no play-by-play' note, say so.\n\n"
